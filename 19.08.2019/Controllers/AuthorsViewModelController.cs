...
{
    public class AuthorsViewModelController : Controller
    {
        IMapper mapper;
        public AuthorsViewModelController(IMapper mapperParam)
        {
            mapper = mapperParam;
        }
        // GET: Author
        ...
        {
            var authorDTO = mapper.ServiceCtor.Invoke(typeof(AuthorsDTO));
            var authorList = (authorDTO as AuthorsDTO).GetAll();
